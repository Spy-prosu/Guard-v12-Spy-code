...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
   ...
   message.channel.send(new MessageEmbed().setColor("RANDOM").setFooter("By Eren.izm").setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setDescription(`${kullanıcı} Başarıyla Afk Oldunuz Afk Olmanızın Sebebi: **${ramo}**`));
